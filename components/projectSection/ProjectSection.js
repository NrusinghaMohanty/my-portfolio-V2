            ...
            <div className={styles.projectsectionContainer}>
                ...
                <div className={styles.projectDiv}>
                    ...
                    <div className={styles.projectDetails}>
                        <p>An Ecommerce Store built using React, HTML and CSS. Using this app you can check the products, add them to cart and wishlist, sort them according to price,etc.</p>
